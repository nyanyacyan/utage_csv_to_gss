...
class GssInfo(Enum):
    ...
    UTAGE = {
        ...
        "SHEET_URL": "https://docs.google.com/spreadsheets/d/143M93N4Zr59rNrPCbrsLPDdyt2UakvEN8a1WwHncH7k/edit?gid=0#gid=0",
...
class ErrCommentInfo(Enum):
    ...
    UTAGE = {
        ...
        "": "",
        "GSS_URL_ERROR": "スプレッドシートに記載されているURLが正しくありません（絞り込み条件設定をしてあるURLになっていない）",
        "": "",
        "": "",
        "": "",
        "": "",
